...
public class Show_color extends AppCompatActivity {
...
TextView col1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHelper.addColor();
        showColor();
        final MediaPlayer mediaPlayer=MediaPlayer.create(this,R.raw.red_tts);
        final MediaPlayer mediaPlayer2=MediaPlayer.create(this,R.raw.yellow_tts1);
        final MediaPlayer mediaPlayer3=MediaPlayer.create(this,R.raw.blue_tts1);
    ...
    public void showColor()
    {
        ...
        String[] columns = { DatabaseContract.Color._ID, COLOR_C1, COLOR_C3};
        String sortOrder = DatabaseContract.Color._ID + " ASC";
        Cursor c = db.query(TABLEcol_NAME, columns, null, null, null, null, sortOrder);
int i=-1;
        while (c.moveToNext()) {
            Long id= c.getLong(0) ;
